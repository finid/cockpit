...
PageSetupServer.prototype = {
    ...
    enter: function(first_visit) {
        ...
        $('#dashboard_setup_login_use_custom_creds').attr('checked', false);
        $('#dashboard_setup_login_use_custom_creds').checkboxradio('refresh');
        $('.dashboard_setup_login_custom_creds_row').hide();
